/*  minIni - Multi-Platform INI file parser, suitable for embedded systemsvi mi I   
 *  c   
 *  c   
 *  qxpdf minI    pd  
 *  vi te   .c  
 ...
 * \param Section     the name of the section to write the value in
 ...
 cdll
 ll sr  
 cd * \param Key         the name of the entry to write
 * \param Value       the value to write
 *k fr  fr  
 ll
 vi fr  
