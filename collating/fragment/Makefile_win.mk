...
$(FRAGMENT_CLASSIFIER).dll:
	cl /c src\fragment_classifier.c /Iinclude /Iinclude\magic
	cl /c src\entropy\entropy.c /Iinclude\entropy /Iinclude
	link .\lib\magic\dll64\magic.lib fragment_classifier.obj entropy.obj /DLL /out:$(FRAGMENT_CLASSIFIER).dll
